...
declare module 'yup' {
  ...
  declare export type TestOptionsMessage = string | ((params: $Shape<TestMessageParams>) => string);
  ...
  declare export interface BaseSchema<T, GetHighType> {
    ...
    validateSync(value: any, options?: $Diff<ValidateOptions, { sync: any, ... }>): T;
    validateAt(
      path: string,
      value: T,
  ...
  declare export interface Schema<T, GetHighType> extends BaseSchema<T, GetHighType> {
    ...
    isValidSync(value: any, options?: $Diff<ValidateOptions, { sync: any, ... }>): boolean;
    ...
    oneOf(arrayOfValues: $ReadOnlyArray<T>, message?: TestOptionsMessage): $Call<GetHighType, T>;
    notOneOf(arrayOfValues: $ReadOnlyArray<T>, message?: TestOptionsMessage): $Call<GetHighType, T>;
    when(
  ...
  declare export type TransformFunction = (value: any, originalValue: any) => any;
  ...
  declare export type WhenOptions<T> = WhenOptionsBuilderFunction<T> | WhenOptionsBuilderObject;
  ...
  declare export function ref<T>(path: string, options?: {| contextPrefix: string |}): Ref<T>;
...
declare module 'yup/lib/setLocale' {
  ...
  declare export type LocaleObject = {|
    ...
    string?: LocaleDescriptor<
      'length' | 'min' | 'max' | 'matches' | 'email' | 'url' | 'trim' | 'lowercase' | 'uppercase',
    >,
    number?: LocaleDescriptor<
      'min ' | 'max' | 'lessThan' | 'moreThan' | 'notEqual' | 'positive' | 'negative' | 'integer',
    >,
    boolean?: { ... },
    bool?: { ... },
...
declare module 'yup/lib/string' {
  ...
  declare export interface StringSchema<T> extends Schema<T, GetterStringSchema> {
    length(limit: number | Ref<any>, message?: TestOptionsMessage): StringSchema<T>;
    min(limit: number | Ref<any>, message?: TestOptionsMessage): StringSchema<T>;
    max(limit: number | Ref<any>, message?: TestOptionsMessage): StringSchema<T>;
...
declare module 'yup/lib/number' {
  ...
  declare export interface NumberSchema<T> extends Schema<T, GetterNumberSchema> {
    lessThan(limit: number | Ref<any>, message?: TestOptionsMessage): NumberSchema<T>;
    moreThan(limit: number | Ref<any>, message?: TestOptionsMessage): NumberSchema<T>;
    min(limit: number | Ref<any>, message?: TestOptionsMessage): NumberSchema<T>;
    max(limit: number | Ref<any>, message?: TestOptionsMessage): NumberSchema<T>;
...
declare module 'yup/lib/bool' {
  ...
  declare export interface BooleanSchema<T> extends Schema<T, GetterBooleanSchema> {
...
declare module 'yup/lib/date' {
  declare export type DateSchemaConstructor = Class<DateSchema<Date>> & (() => DateSchema<Date>);
  ...
  declare export interface DateSchema<T> extends Schema<T, GetterDateSchema> {
    min(limit: Date | string | Ref<any>, message?: TestOptionsMessage): DateSchema<T>;
    max(limit: Date | string | Ref<any>, message?: TestOptionsMessage): DateSchema<T>;
...
declare module 'yup/lib/array' {
  ...
  declare export interface ArraySchema<T> extends Schema<T, GetterArraySchema> {
    ...
    compact(rejector?: (value: any, index: number, array: Array<T>) => boolean): ArraySchema<T>;
...
declare module 'yup/lib/object' {
  ...
  declare export interface ObjectSchema<T> extends Schema<T, GetterObjectSchema> {
    shape<U>(
      fields: U,
