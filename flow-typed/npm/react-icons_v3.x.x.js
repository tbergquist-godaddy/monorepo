...
// flow-typed signature: c0f9d8e0c6e687cbead41c3998be8316
// flow-typed version: <<STUB>>/react-icons_v3/flow_v0.119.1
...
declare module 'react-icons/md' {
  declare export function MdPlayArrow(props: IconProps): React$Node;
  declare export function MdMenu(props: IconProps): React$Node;
  declare export function MdPlayArrow(props: IconProps): React$Node;
  declare export function MdFavorite(props: IconProps): React$Node;
  declare export function MdChevronLeft(props: IconProps): React$Node;
  declare export function MdPause(props: IconProps): React$Node;
  declare export function MdStop(props: IconProps): React$Node;
  ...
  declare export function MdExpandMore(props: IconProps): React$Node;
}
