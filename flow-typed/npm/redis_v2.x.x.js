...
declare type $npm$redis$DelWithRestKeys1 = (key: string, callback: $npm$redis$DelCallback) => void;
...
declare module 'redis' {
  declare class RedisClient extends events$EventEmitter mixins RedisClientPromisified {
    ...
    rpush: (key: string, value: string, callback?: (error: ?Error) => void) => void;
    lpush: (
      key: string,
      value: string,
    ...
    llen: (key: string, callback: (error: ?Error, length: number) => void) => void;
    hset: (
      topic: string,
      key: string,
      value: string,
    ...
    del: $npm$redis$DelF;
    mget: (keys: Array<string>, callback: (error: ?Error, values: Array<?string>) => void) => void;
    mset: (keysAndValues: Array<string>, callback?: (error: ?Error, result: 'OK') => void) => void;
    rpoplpush: (
      source: string,
      destination: string,
      callback?: (error: ?Error, result: string) => void,
    ...
    quit: () => void;
    keys: (pattern: string, callback?: (error: ?Error, keys: string[]) => void) => void;
    expire: (
      key: string,
      timeout: number,
      callback?: (error: ?Error, timeoutWasSet: number) => void,
    ) => void;
    incr: (key: string, callback: (error: ?Error, result: ?number) => void) => void;
    incrby: (
      key: string,
      increment: number,
    ...
    decr: (key: string, callback: (error: ?Error, result: ?number) => void) => void;
    decrby: (
      key: string,
      decrement: number,
      callback: (error: ?Error, result: ?number) => void,
  ...
  declare class RedisClientPromisified extends RedisClient {
    ...
    lrangeAsync: (topic: string, cursor: number, cursor2: number) => Promise<Array<string>>;
    ...
    hgetallAsync: (topic: string) => Promise<{ [key: string]: string, ... }> | Promise<void>;
